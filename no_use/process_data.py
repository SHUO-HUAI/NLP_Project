# following https://github.com/abisee/cnn-dailymail
...
os.environ['CLASSPATH'] = './aajar/stanford-corenlp-4.2.0.jar'
...
if __name__ == '__main__':
    ...
    # Chunk the data. This splits each of train.bin, val.bin and test.bin into smaller chunks, each containing e.g.
    # 1000 examples, and saves them in finished_files/chunks
    chunk_all()
